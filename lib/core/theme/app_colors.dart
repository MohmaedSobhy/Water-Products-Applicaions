...
abstract class AppColor {
  ...
  static const Color gray = Color(0xFFB7B6B6);
  static const Color lightGrey = Color(0xFFE7E7E7);
  static const Color white = Color(0xFFFFFFFF);

  static const Color red = Color(0xFFFF0101);
  static const Color green = Color(0xFF08FD08);
  static const Color blue = Color(0xFF1A57EF);
  static const Color yellow = Color(0xFFFFFD0D);
}
